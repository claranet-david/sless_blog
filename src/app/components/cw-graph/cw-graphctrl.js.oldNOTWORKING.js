(function(){
	...
	angular
		...
		cloudWatchGraphController.$inject = ['$scope', '$http', '$routeParams','$q','loginService', 'customAWSService'];
		...
		function cloudWatchGraphController($scope, $http, $routeParams, $q, loginService, customAWSService){
            ...
            AwsCloudWatchChart = function(config){
                ...
                this.cloudwatch = new customAWSService.AWS.CloudWatch();
            ...
            vm.acs = new AwsCloudWatchChart(config);
            vm.acs.getChart().then(function(chart){
